package hust.ccs.demo.lemurdemo;
...
import hust.ccs.*;
import hust.ccs.demo.gui.lemur.AudioHud;
import hust.ccs.demo.gui.lemur.CameraNameState;
import hust.ccs.demo.gui.lemur.DriverHud;
import hust.ccs.demo.gui.lemur.PhysicsHud;
import hust.ccs.demo.gui.menu.MainMenu;
import hust.ccs.demo.input.*;
 ...
 */
final public class AppDemo extends SimpleApplication {
    // *************************************************************************
    ...
    final private static Logger logger
            = Logger.getLogger(AppDemo.class.getName());
    // *************************************************************************
    // fields
...
//        new Rotator(),
     ...
     */
    private static AppDemo application;
    /**
     ...
     */
    private static Vehicle vehicle = new HoverTank();
    /**
     ...
     * @return the pre-existing instance (not null)
     */
    public static AppDemo getApplication() {
