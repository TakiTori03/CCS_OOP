...
class EngineSoundMenu extends AnimatedMenu {
    ...
    protected void onDisable() {
        ...
        AppDemo.getVehicle().getEngine().setSound(selectedSound);
        selectedSound = null;
    ...
    protected void onEnable() {
        ...
        Sound engineSound = AppDemo.getVehicle().getEngine().getSound();
        if (engineSound == null) {
            selectedSound = null;
        } else {
            try {
            ...
            AssetManager assetManager
                    = AppDemo.getApplication().getAssetManager();
            selectedSound.load(assetManager);
            configureSelectedSound();

            Node node = AppDemo.getVehicle().getNode();
