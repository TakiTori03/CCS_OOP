...
import hust.ccs.*;
import hust.ccs.examples.props.WarningSign;
...
import hust.ccs.gui.SteeringWheelState;
import hust.ccs.gui.TachometerState;
...
final public class AppDemo extends SimpleApplication {
    ...
    /**
     * Main entry point for the AppDemo application.
     *
    ...
    /**
     * Initialize the AppDemo application.
     */
    @Override
...
//        System.out.print(attributionMessage);
    ...
    private static void addParkedVehicles(
        ...
        Vehicle parkedVehicle = new HoverTank();
